...
@Entity
public class StockSalesView implements Serializable {
    @Id
    private int id;
    @JsonIgnore
    ...
    private Set<StockSalesItemView> items;
    @OneToMany(fetch = FetchType.EAGER, cascade = CascadeType.ALL)
    ...
    public Set<StockSalesItemView> getItems() {
        return items;
    }

    public void setItems(Set<StockSalesItemView> items) {
        this.items = items;
    }
}
