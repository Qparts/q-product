...
@Entity
public class StockQuotationView implements Serializable {
    @Id
    private int id;
    @JsonIgnore
    ...
    private List<StockQuotationItemView> items;
    ...
    public List<StockQuotationItemView> getItems() {
        return items;
    }

    public void setItems(List<StockQuotationItemView> items) {
        this.items = items;
    }
